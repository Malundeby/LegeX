/**
 * Script for å generere MADRS pasientskjema PDF med jspdf
 * Kjør: npm install jspdf && node scripts/generate-madrs-pdf-jspdf.js
 */
...
function generateMADRSPDF() {
  ...
  const interpretations = [
    { range: '0-6', label: 'Ingen/minimal', color: [212, 237, 218] },
    { range: '7-19', label: 'Lett depresjon', color: [255, 243, 205] },
    { range: '20-34', label: 'Moderat depresjon', color: [255, 224, 178] },
    { range: '35-60', label: 'Alvorlig depresjon', color: [248, 215, 218] }
  ];
